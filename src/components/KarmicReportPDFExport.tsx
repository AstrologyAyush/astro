...
const KarmicReportPDFExport: React.FC<KarmicReportPDFExportProps> = ({ language, reportData }) => {
  ...
  const generatePDF = () => {
    try {
      ...
      doc.text('🪔 ' + (language === 'hi' ? 'आपकी व्यक्तिगत करियर कर्म रिपोर्ट' : 'Your Personalized Career Karma Report'), 20, yPosition);
      
      yPosition += 10;
      doc.setFontSize(12);
      doc.setTextColor(100, 100, 100);
      doc.text(language === 'hi' ? 'आयु एस्ट्रो द्वारा उत्पन्न · ज्योतिष + NLP + जेमिनी AI द्वारा संचालित' : 'Generated by Ayu Astro · Powered by Jyotish + NLP + Gemini AI', 20, yPosition);
      ...
      doc.setFontSize(16);
      doc.setTextColor(90, 75, 218);
      doc.text(language === 'hi' ? '3. आदर्श करियर पथ' : '3. Ideal Career Path', 20, yPosition);
      yPosition += 10;
      ...
      doc.setFontSize(16);
      doc.setTextColor(90, 75, 218);
      doc.text(language === 'hi' ? '5. साप्ताहिक कर्म कार्य' : '5. Weekly Karma Actions', 20, yPosition);
      yPosition += 10;
      ...
      doc.setFontSize(16);
      doc.setTextColor(90, 75, 218);
      doc.text(language === 'hi' ? '7. आपके कर्मिक कोच का संदेश' : '7. Message from Your Karmic Coach', 20, yPosition);
      yPosition += 10;
      ...
      doc.setFontSize(10);
      doc.setTextColor(100, 100, 100);
      doc.text(language === 'hi' ? 'आयु एस्ट्रो द्वारा उत्पन्न · स्विस एफेमेरिस + जेमिनी AI द्वारा संचालित' : 'Generated by Ayu Astro · Powered by Swiss Ephemeris + Gemini AI', 20, yPosition);
      yPosition += 6;
      ...
      toast({
        ...
        description: language === 'hi' ? "PDF बनाने में त्रुटि हुई" : "Error generating PDF",
        variant: "destructive"
      });
    }
  };
