...
const HeroSection: React.FC<HeroSectionProps> = ({
  ...
  return <div className="text-center mb-4 md:mb-6 px-2 sm:px-4 lg:px-6">
      ...
      <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto mb-4 md:mb-6 px-4 leading-relaxed">
        {getTranslation("Discover Your Destiny with Precision - Advanced Astronomical Calculations & Rishi Parasher Guidance", "उन्नत खगोलीय गणना और पं. ऋषि पराशर के मार्गदर्शन के साथ अपने भाग्य की सटीक खोज करें")}
      </p>
      ...
      <div className="flex flex-col gap-2 sm:gap-3 justify-center mt-4 md:mt-6 px-4 max-w-lg mx-auto">
        <Button onClick={handleGetStarted} className="bg-gradient-to-r from-orange-600 to-red-600 hover:from-orange-700 hover:to-red-700 text-white text-xs sm:text-sm md:text-base px-3 sm:px-4 md:px-6 py-3 md:py-4 rounded-full shadow-lg w-full transition-all duration-300 transform hover:scale-105 min-h-[44px]">
        ...
        <Button variant="outline" onClick={handlePersonalityTest} className="border-purple-600 text-purple-600 hover:bg-purple-50 dark:hover:bg-purple-900/20 text-xs sm:text-sm md:text-base px-3 sm:px-4 md:px-6 py-3 md:py-4 rounded-full w-full transition-all duration-300 min-h-[44px]">
        ...
        <Button variant="outline" onClick={handleDailyHoroscope} className="border-blue-600 text-blue-600 hover:bg-blue-50 dark:hover:bg-blue-900/20 text-xs sm:text-sm md:text-base px-3 sm:px-4 md:px-6 py-3 md:py-4 rounded-full w-full transition-all duration-300 min-h-[44px]">
        ...
        <Button variant="outline" onClick={handleTryEngine} className="border-green-600 text-green-600 hover:bg-green-50 dark:hover:bg-green-900/20 text-xs sm:text-sm md:text-base px-3 sm:px-4 md:px-6 py-3 md:py-4 rounded-full w-full transition-all duration-300 min-h-[44px]">
