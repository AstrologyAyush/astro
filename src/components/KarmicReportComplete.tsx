  ...
  return <div className="w-full max-w-none mx-auto px-2 sm:px-4">
      ...
      <Card className="w-full border-purple-200 shadow-lg mb-4 sm:mb-6">
        <CardHeader className="bg-gradient-to-r from-purple-100 to-indigo-100 p-3 sm:p-6">
          <div className="flex items-center justify-between flex-col gap-3 sm:flex-row sm:gap-4">
            <div className="flex items-center gap-2 sm:gap-3 text-center sm:text-left">
              <div className="p-1.5 sm:p-2 bg-gradient-to-r from-purple-500 to-indigo-500 rounded-full">
                <Sparkles className="h-4 w-4 sm:h-6 sm:w-6 text-white" />
              </div>
              <div>
                <CardTitle className="text-purple-800 text-lg sm:text-xl">
                  🪔 {getTranslation('Your Personalized Career Karma Report', 'आपकी व्यक्तिगत कर्मिक रिपोर्ट')}
                </CardTitle>
                <p className="text-purple-600 text-xs sm:text-sm mt-1">
                  {getTranslation('Analyzed and Written By Maharishi Parasher', 'महार्षि पराशर द्वारा विश्लेषित और लिखित')}
                </p>
              </div>
            </div>
      ...
      {!personalizedData ? <div className="text-center py-8 sm:py-12 px-4">
          ...
          <Card className="border-orange-200" id="career-signature">
            ...
            <CardContent className="p-3 sm:p-6">
              ...
              <div className="bg-orange-50 p-3 rounded-lg">
                <p className="text-xs sm:text-sm text-gray-600">{getTranslation('Planetary Analysis', 'ग्रहीय विश्लेषण')}:</p>
                <p className="text-gray-700 font-medium text-sm">{personalizedData.d10Analysis}</p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border-red-200" id="career-blocks">
            <CardHeader className="bg-red-50 p-3 sm:p-4">
          ...
          <Card className="border-blue-200" id="karmic-timeline">
            <CardHeader className="bg-blue-50 p-3 sm:p-4">
            ...
            <CardContent className="p-3 sm:p-6">
              <div className="bg-blue-50 p-3 sm:p-4 rounded-lg">
                <p className="text-gray-700 font-medium text-sm">{personalizedData.timeline}</p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border-purple-200" id="karma-alignment">
            <CardHeader className="bg-purple-50 p-3 sm:p-4">
          ...
          <Card className="border-indigo-200" id="weekly-actions">
            <CardHeader className="bg-indigo-50 p-3 sm:p-4">
              <CardTitle className="text-indigo-800 flex items-center gap-2 text-sm sm:text-base">
                <Calendar className="h-4 w-4 sm:h-5 sm:w-5" />
          ...
          <Card className="border-yellow-200" id="coach-message">
            <CardHeader className="bg-yellow-50 p-3 sm:p-4">
              <CardTitle className="text-yellow-800 flex items-center gap-2 text-sm sm:text-base">
                <Sparkles className="h-4 w-4 sm:h-5 sm:w-5" />
                {getTranslation('7. Message from Your Karmic Coach', '7. आपके कर्मिक कोच का संदेश')}
              </CardTitle>
            </CardHeader>
            <CardContent className="p-3 sm:p-6">
              <blockquote className="border-l-4 border-yellow-400 pl-3 sm:pl-4 italic text-base sm:text-lg text-gray-700 bg-yellow-50 p-3 sm:p-4 rounded-r-lg">
          ...
          <Card className="border-emerald-200" id="remedies">
            <CardHeader className="bg-emerald-50 p-3 sm:p-4">
              <CardTitle className="text-emerald-800 flex items-center gap-2 text-sm sm:text-base">
          ...
          <Card className="border-gray-200" id="footer">
            <CardContent className="p-3 sm:p-6 text-center">
              <p className="mb-2 sm:text-sm text-red-800 font-extralight text-xs">
                Completely Created By AyuAstro
              </p>
